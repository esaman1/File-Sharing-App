...
import com.datasharing.Adapter.ImagePickAdapter;
 ...
 */
public class PhotosFragment extends MainFragment {
...
//        tv_count.setText(mCurrentNumber + "/" + mMaxNumber);
        ...
        mRecyclerView = view.findViewById(R.id.rv_image_pick);
...
//                    tv_count.setText(mCurrentNumber + "/" + mMaxNumber);
                    ...
                    for (ImageFile file : mAdapter.getDataSet()) {
                        file.setSelected(mSelectedList.contains(file));
                    }
...
//                tv_count.setText(mCurrentNumber + "/" + mMaxNumber);
    ...
    private final class LongOperation extends AsyncTask<Void, Void, List<ImageFile>> {
        ...
        protected List<ImageFile> doInBackground(Void... params) {
            ...
            getActivity().runOnUiThread(() -> tv_app.setText(directories.get(0).getName() + " (" + list.size() + ")"));
...
//            onScrolledToBottom();
    ...
    private class MyReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            PhotosFragment.this.notifyData();
        }
    }
