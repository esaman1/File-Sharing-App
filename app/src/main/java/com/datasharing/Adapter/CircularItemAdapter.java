...
public class CircularItemAdapter extends RecyclerView.Adapter<CircularItemAdapter.ItemHolder> {
    ...
    private final List<ScanResult> mItems;       // custom data, here we simply use string
    ...
    public ItemHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.circular_items, parent, false);
