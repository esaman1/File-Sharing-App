...
import com.datasharing.filter.loader.ApkLoader;
import com.datasharing.filter.loader.AudioLoader;
import com.datasharing.filter.loader.ImageLoader;
import com.datasharing.filter.loader.VideoLoader;
...
public class ApkfilecallBack implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private final ApkResultCallback resultCallback;
    private final String[] mSuffixArgs;
    private final String mSuffixRegex;
