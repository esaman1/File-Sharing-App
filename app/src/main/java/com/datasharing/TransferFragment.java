...
import com.datasharing.Adapter.CircularItemAdapter;
import com.datasharing.Application.MyApplicationClass;
import com.datasharing.Const.Constant;
import com.datasharing.Database.DBHelper;
import com.datasharing.Interfaces.ApplicationKillListener;
import com.datasharing.Interfaces.CallBackListener;
import com.datasharing.Interfaces.SendReceiveFragmentView;
import com.datasharing.Interfaces.SendReceiveListPresenter;
import com.datasharing.Interfaces.TCPListener;
import com.datasharing.JSONHelper.JsonHelper;
import com.datasharing.Model.SendFileModel;
import com.datasharing.Services.AppKillDetectionService;
import com.datasharing.Services.HotSpotService;
import com.datasharing.Services.SendReceiveListPresenterImpl;
import com.datasharing.Services.TCPCommunicator;
import com.datasharing.Services.WiFiAddress;
import com.datasharing.Services.WifiHotSpots;
import com.datasharing.SharedPrefrance.PreferenceHelper;
import com.datasharing.databinding.FragmentTransferBinding;
...
import static com.datasharing.JSONHelper.JsonHelper.FILE;
...
public class TransferFragment extends Fragment implements
    ...
    public static FragmentTransferBinding fragmentPlayListBinding;
    ...
    private final String[] icon = new String[]{"HISTORY", "APP", "PHOTO", "MUSIC", "VIDEO", "FILE"};
...
//    private AdView adView;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        fragmentPlayListBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_transfer, container, false);
...
//                fireAnalytics("Receive Connection", "Request");
                        ...
                        for (int i = 0; i < list.size(); i++) {
                            ...
                            if (list.get(i).type == null || list.get(i).type.equals(FILE)) {
                                ...
                                getActivity().runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        fragmentPlayListBinding.tvSendFile.setText("SEND");
                                    }
                                });
                            }
                        }
    ...
    private void showLongTapDialog() {
        ...
        dialog1.setContentView(R.layout.dialog_connected);
...
//        builder.show();
    ...
    public void onErrorMessage(String message) {
        ...
        Log.d("HomeActivity", "error" + message + "");
    ...
    private void showWiFiAssistDialog() {
        ...
        @SuppressLint("InflateParams") View child = inflater.inflate(R.layout.dialog_wifi_warning, null);
    ...
    private void showAgainWiFiAssistDialog() {
        ...
        LayoutInflater inflater = (LayoutInflater) mainActivity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        if (inflater == null) return;
        @SuppressLint("InflateParams") View child = inflater.inflate(R.layout.dialog_wifi_warning_1, null);
    ...
    public void setViewPager() {
        ...
        fragmentPlayListBinding.tabDownload.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                TextView imageView = Objects.requireNonNull(tab.getCustomView()).findViewById(R.id.img_tab);
                imageView.setTextColor(getContext().getResources().getColor(R.color.white));
            }

            @Override
            public void onTabUnselected(TabLayout.Tab tab) {
                TextView imageView = Objects.requireNonNull(tab.getCustomView()).findViewById(R.id.img_tab);
                imageView.setTextColor(getContext().getResources().getColor(R.color.tabcolor));
            }
...
//        bundle.putString(FirebaseAnalytics.Param.ITEM_ID, "TransferFragment");
